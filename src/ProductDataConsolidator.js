...
export default function ProductDataConsolidator() { }

ProductDataConsolidator.get = function () {
	let l = new LawnmowerRepository().getAll();
	let p = new PhoneCaseRepository().getAll();
	let t = new TShirtRepository().getAll();
